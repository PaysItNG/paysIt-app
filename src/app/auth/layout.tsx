    ...
    <>
      <div className="flex flex-col w-full min-h-screen md:grid md:h-screen md:min-h-0 md:grid-cols-12 md:overflow-hidden">
        <div className="md:col-span-7">
          <div className="pattern-4 flex h-full flex-col justify-between overflow-hidden rounded-r-md md:rounded-r-2xl bg-green-900 px-8 py-12 text-white md:px-16 md:py-20">
