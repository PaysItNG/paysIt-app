...
const HeroNotification = ({ avatar, message, className }: HeroNotificationPropType) => (
    <div
  //   absolute -left-16 bottom-1/4 bg-white p-4 rounded-xl shadow-lg animate-float-delayed
      ...
      <Image src={avatar} alt="User avatar" width={40} height={50} className="w-8 h-8 rounded-full" />
