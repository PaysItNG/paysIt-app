    ...
    <main>
      <div className="bg-[#F5F7FA]">
        <div className="mx-auto max-w-screen-xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 px-6 md:px-10 lg:px-0 py-16">
            <div className="relative h-72 md:h-96 lg:h-full flex items-center">
              ...
              <Image
                ...
                height={320}
                width={320}
                className="w-full h-full md:h-full object-cover rounded-lg shadow-xl"
              />
              <div className="absolute p-6 lg:hidden">
                <motion.h2
                  initial={{ y: 50, opacity: 0 }}
                  whileInView={{ y: 0, opacity: 1 }}
                  transition={{ duration: 0.8 }}
                  className="text-4xl font-bold text-center lg:text-left text-white"
                >
                  Why Choose PaysIt
                </motion.h2>
                <motion.p
                  ...
                  whileInView={{ y: 0, opacity: 1 }}
                  transition={{ duration: 0.8 }}
                  className="text-lg text-gray-50 mt-2"
                >
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex justify-center mt-8">
                <div className="grid grid-cols-1 md:grid-cols-2 md:gap-6 max-w-4xl">
...
const ReasonCard: React.FC<ReasonCardType> = ({
  ...
  return (
    <motion.div whileHover={{ y: -10 }} className="p-4 md:p-6 h-full">
